    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <i class="fas fa-plus-circle"></i> Create Guest
                </a>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Guest Table</h3>
                    </div>
                    <!-- /.card-header -->
                            ...
                            <tbody>
                                @foreach($guests as $key => $value)
                                    <tr>
                                        ...
                                        <td>{{$value->guest_contact}}</td>
                                        <td>
                                            <button type="button" class="btn btn-outline-primary"><i class="far fa-eye"></i> View</button>
                                            <a href="{{url('guest/'.$value->id.'/edit')}}" type="button" class="btn btn-outline-info"><i class="far fa-edit"></i> Edit</a>
                                            
                                            <form action="{{url('/guest/'.$value->id)}}" method="POST" style="display: inline">
                                                @csrf
                                                @method('DELETE')

	            ...
	            <div class="col-lg-6">
	                <div class="s_Product_carousel">
	                    <div class="single-prd-item">
	                        <img class="img-fluid" src="<?php echo e(asset('frontend/assets/img/category/s-p1.jpg')); ?>" alt="">
	                    </div>
	                    <div class="single-prd-item">
	                        <img class="img-fluid" src="<?php echo e(asset('frontend/assets/img/category/s-p1.jpg')); ?>" alt="">
	                    </div>
	            ...
	            <div class="col-lg-5 offset-lg-1">
	                <div class="s_product_text">
	                    ...
	                    <div class="card_area d-flex align-items-center">
	                        <a class="primary-btn" href="<?php echo e(url('/cart')); ?>">បន្តែមចូលកន្ត្រក</a>
	                    ...
	                    <div class="col-lg-6">
	                        <div class="comment_list">
	                            <div class="review_item">
	                                <div class="media">
	                                    <div class="d-flex">
	                                        <img src="<?php echo e(asset('frontend/assets/img/product/review-1.png')); ?>" alt="">
	                                    </div>
	                            ...
	                            <div class="review_item reply">
	                                <div class="media">
	                                    <div class="d-flex">
	                                        <img src="<?php echo e(asset('frontend/assets/img/product/review-2.png')); ?>" alt="">
	                                    </div>
	                                    <div class="media-body">
	                                        <h4>Blake Ruiz</h4>
	                                        <h5>12th Feb, 2018 at 05:56 pm</h5>
	                            ...
	                            <div class="review_item">
	                                <div class="media">
	                                    <div class="d-flex">
	                                        <img src="<?php echo e(asset('frontend/assets/img/product/review-3.png')); ?>" alt="">
	                                    </div>
	                                    <div class="media-body">
	                                        <h4>Blake Ruiz</h4>
	                                        <h5>12th Feb, 2018 at 05:56 pm</h5>
...
<?php echo $__env->make('frontend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\E-commerce\c2c-shop - Copy\resources\views/frontend/product/productDetail.blade.php ENDPATH**/ ?>
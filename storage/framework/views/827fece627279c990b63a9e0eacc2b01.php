    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#" aria-expanded="false">
            <i class="flag-icon flag-icon-<?php echo e($flagIcon); ?>"></i>
        </a>
        <div class="dropdown-menu dropdown-menu-right p-0" style="left: inherit; right: 0px;">
            <a href="<?php echo e(url('lang/en')); ?>" class="dropdown-item <?php echo e($locale === 'en' ? 'active' : ''); ?>">
                <i class="flag-icon flag-icon-us mr-2"></i> English
            </a>
            <a href="<?php echo e(url('lang/kh')); ?>" class="dropdown-item <?php echo e($locale === 'kh' ? 'active' : ''); ?>">
                <i class="flag-icon flag-icon-kh mr-2"></i> Khmer
            </a>
            <a href="<?php echo e(url('lang/cn')); ?>" class="dropdown-item <?php echo e($locale === 'cn' ? 'active' : ''); ?>">

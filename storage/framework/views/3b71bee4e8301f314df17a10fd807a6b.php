                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="nav-item">
                            <a href="<?php echo e(route('cart.index')); ?>" class="nav-link">
                                ...
                                (<span id="cart-badge"><?php echo e(collect(session('cart', []))->sum('qty')); ?></span>)
                            </a>
                        </li>
...
<?php /**PATH C:\wamp64\www\E-commerce\c2c-shop - Copy\resources\views/frontend/layout/header.blade.php ENDPATH**/ ?>
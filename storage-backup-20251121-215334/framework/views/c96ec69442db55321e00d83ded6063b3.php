              ...
              <table class="table table-hover mb-0">
                ...
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <td style="width:80px">
                      <?php if(!empty($p->images[0]) && file_exists(public_path('storage/'.$p->images[0]))): ?>
                        <img src="<?php echo e(asset('storage/'.$p->images[0])); ?>" style="width:64px;height:48px;object-fit:cover;border-radius:4px;">
                      <?php else: ?>
                    ...
                    <td class="text-right">
                      ...
                      <form action="<?php echo e(route('admin.products.destroy', $p->id)); ?>" method="post" style="display:inline-block" onsubmit="return confirm('Delete product?');">
                        <?php echo csrf_field(); ?>

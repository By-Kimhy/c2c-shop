...
<?php $__env->startSection('d_menu-open', 'menu-open'); ?>
<?php $__env->startSection('d_active', 'active'); ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h3><?php echo e($newOrdersCount ?? 0); ?></h3>
                            <p>New Orders (today)</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-bag"></i>
                        </div>
                        <a href="<?php echo e(route('admin.orders.index')); ?>" class="small-box-footer">Orders <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h3><?php echo e($bounceRate ?? 0); ?><sup style="font-size: 20px">%</sup></h3>
                            <p>Bounce Rate</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3><?php echo e($userRegistrations ?? 0); ?></h3>
                            <p>User Registrations (this month)</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-person-add"></i>
                        </div>
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="small-box-footer">Users <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-danger">
                        <div class="inner">
                            <h3><?php echo e($uniqueVisitors ?? 0); ?></h3>
                            <p>Unique Visitors</p>
                        </div>
                        <div class="icon">
                ...
                <section class="col-lg-7 connectedSortable">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn btn-tool">View all</a>
                            </div>
                        </div>
                        <div class="card-body p-0">
                            <ul class="products-list product-list-in-card pl-2 pr-2">
                                <?php $__empty_1 = true; $__currentLoopData = $recentOrders ?? collect(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <li class="item">
                                        <div class="product-img">
                                            <img src="<?php echo e(asset('backend/dist/img/default-product.png')); ?>" alt="Product Image" class="img-size-50">
                                        </div>
                                        <div class="product-info">
                                            <a href="<?php echo e(route('admin.orders.show', $order->id ?? '#')); ?>" class="product-title">#<?php echo e($order->order_number ?? '—'); ?>

                                                <span class="badge badge-warning float-right"><?php echo e(number_format($order->total ?? 0, 2)); ?> <?php echo e($order->currency ?? config('app.currency', 'KHR')); ?></span>
                                            </a>
                                            <span class="product-description">
                                                <?php echo e(optional($order->user)->name ?? 'Guest'); ?> — <?php echo e(\Illuminate\Support\Str::limit($order->shipping_address ?? '-', 60)); ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="direct-chat-messages">
                                <div class="direct-chat-msg">
                                    ...
                                    <img class="direct-chat-img" src="<?php echo e(asset('backend/dist/img/user1-128x128.jpg')); ?>" alt="message user image">
                                ...
                                <div class="direct-chat-msg right">
                                    ...
                                    <img class="direct-chat-img" src="<?php echo e(asset('backend/dist/img/user3-128x128.jpg')); ?>" alt="message user image">
                        ...
                        <div class="card-body">
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number"><?php echo e($totalProducts ?? 0); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number"><?php echo e($publishedProducts ?? 0); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number"><?php echo e($sellersCount ?? 0); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number"><?php echo e(number_format($monthlyRevenue ?? 0, 2)); ?> <?php echo e(config('app.currency','KHR')); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer bg-transparent">
                            <div class="row">
                                <div class="col-4 text-center">
                                    <input type="text" class="knob" data-readonly="true" value="<?php echo e($pendingOrders ?? 0); ?>" data-width="60" data-height="60" data-fgColor="#39CCCC">
                                    <div class="text-white">Pending</div>
                                </div>
                                <div class="col-4 text-center">
                                    <input type="text" class="knob" data-readonly="true" value="<?php echo e($paidOrders ?? 0); ?>" data-width="60" data-height="60" data-fgColor="#39CCCC">
                                    <div class="text-white">Paid</div>
                                </div>
                                <div class="col-4 text-center">
                                    <input type="text" class="knob" data-readonly="true" value="<?php echo e($totalProducts ?? 0); ?>" data-width="60" data-height="60" data-fgColor="#39CCCC">
    ...
    if (revCtx) {
        new Chart(revCtx, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: 'Revenue (<?php echo e(config("app.currency", "KHR")); ?>)',
                    data: values,
                    fill: true,
                    tension: 0.3,
                    pointRadius: 3,
    ...
    if (donutCtx) {
        new Chart(donutCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        <?php echo e($paidOrders ?? 0); ?>,
                        <?php echo e($totalProducts ?? 0); ?>,
                        <?php echo e($sellersCount ?? 0); ?>
